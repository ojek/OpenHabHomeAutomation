...
// -- Project -------------------------------------
#define PROJECT                "Sonoff_T1_LivingRoom_Main"          // PROJECT is used as the default topic delimiter and OTA file name
...
#define MQTT_FULLTOPIC         "openhab/in/%topic%/%prefix%" // [FullTopic] Subscribe and Publish full topic name - Legacy topic
